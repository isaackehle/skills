...
Python, TypeScript, JavaScript, React, Next.js, Angular, Node.js, Java, Kotlin, Django, Spring Boot

## Cloud and Infrastructure

AWS (Lambda, ECS, S3, Amplify, RDS, SQS, SNS, CloudWatch, Cognito), Docker, Kubernetes, Terraform, Ansible

## CI/CD and DevOps

Git, GitHub, GitHub Actions, GitLab, Bitbucket, Jenkins, npm, yarn, pnpm, bun
...
OAuth2, OIDC, SAML, JWT, Auth0, Cognito, LDAP
